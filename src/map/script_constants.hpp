...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant(SC_FLOWER_LEAF);
	...
	export_constant(SC_EXPBOOST2);
	export_constant(SC_JEXPBOOST2);
	export_constant(SC_ITEMBOOST2);
	export_constant(SC_EXPBOOST3);
	export_constant(SC_JEXPBOOST3);
	export_constant(SC_ITEMBOOST3);
	export_constant(SC_EXPBOOST4);
	
	export_constant(SC_STORECOUNT);
...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant(IG_LEVEL_UP_BOX110);
	...
	export_constant(IG_LEVEL_UP_BOX175);
	...
	export_constant(IG_DRACULA_SCROLL);
	...
	export_constant(IG_2020_GOAL_BOX);
	export_constant(IG_GOAL_BOX);
	...
	export_constant(IG_2011_RWC_SCROLL);
